...
def get_config(dataset_choice="cifar-10"):
    ...
    dataset_configs = {
        "cifar-10": {
            ...
            "crop_size": 224,
            "batch_size": 256,
            "save_path": os.path.join(project_root, "results", "save", "DualHash", "CIFAR10"),
            "log_dir": os.path.join(project_root, "results", "logs", "DualHash", "CIFAR10"),
            "topK": 1000,
            "topK_mAP": -1,
            "r": 2,
        },
        "nus-wide": {
            ...
            "crop_size": 224,
            "batch_size": 256,
            "save_path": os.path.join(project_root, "results", "save", "DualHash", "NUSWIDE"),
            "log_dir": os.path.join(project_root, "results", "logs", "DualHash", "NUSWIDE"),
            "topK": 1000,
            "topK_mAP": 5000,  
            "r": 2,
        }
